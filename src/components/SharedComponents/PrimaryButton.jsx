...
//         // Find the closest form and submit it manually
//         const form = e.target.closest("form");
//         if (form) form.requestSubmit(); // modern, better than form.submit()
//         setIsLoading(false);
//       }, 500);
//     }
//   };
...
//       onClick={handleClick}
//       disabled={isLoading}
//       className={`w-full h-10 py-2 rounded-lg transition text-white flex items-center justify-center ${
...
const PrimaryButton = ({ children, type = "submit", onClick }) => {
  const [isLoading, setIsLoading] = useState(false);
  const timeoutRef = useRef(null);
